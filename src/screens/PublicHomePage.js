...
const PublicHomePage = props => (
	<div className="w-100 mw8 ph3 center">
    	<Placeholder title="Intro">
	    	...
	    	<p>
	    		Life is both long and far too short; you need perspective. To quote Tim Urban in <a href="https://waitbutwhy.com/2014/05/life-weeks.html" target="_blank" rel="noopener noreferrer">the article you just read</a> (right?!)
